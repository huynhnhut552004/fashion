...
const APIproduct= "http://localhost:3000/Product/Womenproduct";
...
const APICategory= "http://localhost:3000/Product/category";
...
async function search() {
  const query= input.value.trim();
    ...
    timer= setTimeout(()=>{
        fetch(`http://localhost:3000/Product/searchWomen?search=${encodeURIComponent(query)}`)
        .then(res => {
