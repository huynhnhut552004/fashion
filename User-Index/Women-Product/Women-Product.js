...
const APIproduct= "https://fashion-imn4.onrender.com/Product/Womenproduct";
...
async function search() {
  const query= input.value.trim();
    ...
    timer= setTimeout(()=>{
        fetch(`https://fashion-imn4.onrender.com/Product/searchWomen?search=${encodeURIComponent(query)}`)
        .then(res => {
